...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7834214265:AAE9DY2Fn5ASvnGqcvTgAc4e-I8OpZnl-uw")
...
OWNER = os.environ.get("OWNER", "Kazuto_XD") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "5779295913")) # Owner id
#--------------------------------------------
PORT = os.environ.get("PORT", "8001")
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://Carlotta:Carlotta_Premium_Bot@cluster0.vzybzst.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
#--------------------------------------------
START_PIC = os.environ.get("START_PIC", "https://i.ibb.co/QvYNXJY9/x.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://i.ibb.co/xt0Nc7yR/x.jpg")
...
USER_REPLY_TEXT = "<b>ɪᴅɪᴏᴛ!</b> ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴍʏ ᴍᴀꜱᴛᴇʀ!!"
